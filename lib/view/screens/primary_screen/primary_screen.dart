    ...
    return GetBuilder<ThemeController>(
      builder: (theme) => GetBuilder<PrimaryScreenController>(
        builder: (controller) => Scaffold(
          ...
          // body: controller.primaryRepo.apiClient.getInitPrimaryScreenStatus() == false? controller.isLoading ? CustomLoader(loaderColor: MyColor.getPrimaryColor()) :SizedBox.shrink() :
